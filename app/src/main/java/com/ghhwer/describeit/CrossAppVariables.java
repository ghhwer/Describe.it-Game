...
public class CrossAppVariables {
    public static String SHARED_PREFERENCE_NAME = "ghhwer.describeit.sharedPrefs";
    // Settings Related
    public static boolean SHOULD_GET_SYMNS = true;
    public static boolean SHOULD_GET_NOUNS = true;
    public static boolean SHOULD_GET_ADJECTIVE = true;
